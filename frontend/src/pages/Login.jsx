...
import { Lock, Mail, ArrowRight, ShieldCheck, Sparkles, Server, Cpu } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        if (success) {
            ...
            toast.error('Authentication failure. Invalid credentials detected.');
        }
    } catch (err) {
                ...
                <GlassCard className="p-10 md:p-14 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] dark:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.5)] border-white/40 dark:border-white/5 relative overflow-hidden group">
                    ...
                    <div className="mb-12 text-center lg:text-left relative z-10">
                        <div className="flex items-center gap-2 mb-3 justify-center lg:justify-start">
                            ...
                            <span className="text-[10px] font-black text-tytaj-600 dark:text-tytaj-400 uppercase tracking-[0.4em]">Login</span>
                        </div>
                        <h3 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">Sign In</h3>
                        <p className="text-gray-500 dark:text-gray-400 font-medium mt-2">Enter your credentials to continue.</p>
                    </div>
