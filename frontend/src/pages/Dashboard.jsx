        ...
        <div className="space-y-10 pb-10">
            ...
            >
                ...
                <div className="flex gap-4">
                    <AnimatedButton variant="secondary" onClick={() => navigate('/settings')} data-testid="settings-button" className="border-gray-200 dark:border-white/10 dark:bg-white/5">
                        Settings
                    </AnimatedButton>
                    <AnimatedButton onClick={() => navigate('/loans')} data-testid="new-loan-button" className="shadow-xl shadow-tytaj-600/20">
