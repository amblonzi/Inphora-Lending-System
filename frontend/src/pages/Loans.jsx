    ...
    <div className="space-y-10 pb-10">
      ...
      <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-8">
        ...
        <div className="flex flex-col sm:flex-row gap-6 w-full xl:w-auto">
            ...
            <AnimatedButton
                onClick={() => activeTab === 'products' ? setShowProductModal(true) : navigate('/loans/new')}
          ...
          >
            <GlassCard className="!p-10 shadow-2xl border-white/20 dark:border-white/10 relative overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-10 relative z-10">
                    <h3 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">Create Loan Product</h3>
                    <button onClick={() => setShowProductModal(false)} className="text-gray-400 hover:text-gray-600 dark:hover:text-white transition-colors">
                ...
                <form onSubmit={handleCreateProduct} className="space-y-6 relative z-10">
                    <div className="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-2 block">Min Duration (Months)</label>
                            <input 
                        ...
                        <div>
                            <label className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-2 block">Max Duration (Months)</label>
                            <input 
