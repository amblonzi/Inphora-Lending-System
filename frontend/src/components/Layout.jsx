...
import { LayoutDashboard, Users, User, DollarSign, PieChart, LogOut, Settings, Menu, X, Bell, Building2, UsersRound, TrendingUp, Smartphone, History, Shield, Moon, Sun, Terminal, Package, Receipt, CreditCard } from 'lucide-react';
...
const Layout = () => {
  ...
  const menuItems = [
    ...
    { icon: Receipt, label: 'Repayments', path: '/repayments' },
    { icon: CreditCard, label: 'Cheque Discounting', path: '/cheque-discounting' },
