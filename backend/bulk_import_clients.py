...
try:
    ...
    # Fallback: maybe we are running inside backend dir and backend package isn't resolved?
    # Try adding current dir if needed, but 'from backend' implies we must be above it.
