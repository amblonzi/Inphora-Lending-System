...
def list_loans(
    ...
    for loan in loans:
        ...
        loan.outstanding_balance = round(loan.amount + ((loan.amount * loan.interest_rate)/100) + accrued_penalties - total_repaid, 2)
    return loans
...
def get_loan(
    ...
    loan.accrued_penalties = round(accrued_penalties, 2)
    loan.outstanding_balance = round(principal + interest + accrued_penalties - total_repaid, 2)
